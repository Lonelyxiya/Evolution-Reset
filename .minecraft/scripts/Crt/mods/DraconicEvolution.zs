...
FusionCrafting.add(<draconicevolution:draconium_chest>, <mekanism:machineblock:13>.withTag({mekData: {}}), FusionCrafting.DRACONIC, 80000000, [<projecte:rm_furnace>, <usefulbackpacks:backpack:2>, <draconicevolution:draconium_block:1>, <draconicevolution:draconic_core>, <tconstruct:tooltables>, <draconicevolution:wyvern_energy_core>]);
...
FusionCrafting.add(<libvulpes:ore0:10>, <pyrotech:generated_pile_slag_osmium>,  FusionCrafting.DRACONIC, 20480000, [<minecraft:end_rod>, <minecraft:end_rod>, <taiga:obsidioritecobble_block>, <taiga:obsidioritecobble_block>]);
